require 'slide'
require 'page_base'
require 'slides/handson/pages'
require 'opal/websocket'

Gibier.slide_name = 'handson'
...
$document.ready do
  ws = Opal::WebSocket.new("ws://#{`window.location.host`}/push_notification/start/slide/handson") unless Gibier.gh_pages
